      ...
      {isOpen && (
        <div className="whatsapp-form-popup">
          <div className="whatsapp-form-header">
            ...
            <button className="whatsapp-close" onClick={() => setIsOpen(false)} aria-label="Close">
          ...
          <p className="whatsapp-form-subtitle">{t('whatsapp.subtitle')}</p>
          <div className="whatsapp-form-body">
            <div className="whatsapp-field">
              <label>{t('whatsapp.name')}</label>
              <input
                type="text"
                value={name}
            ...
            <div className="whatsapp-field">
              <label>{t('whatsapp.service')}</label>
              <input
                type="text"
                value={service}
                onChange={(e) => setService(e.target.value)}
                placeholder={t('whatsapp.servicePlaceholder')}
              />
            </div>
            <div className="whatsapp-field">
            ...
            <button className="whatsapp-send-btn" onClick={handleSend}>
