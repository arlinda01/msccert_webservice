          ...
          <div className="footer-section">
            ...
            <ul className="footer-contact">
              ...
              <li>
                ...
                <span>Str. Ismail Qemali, Tirana, Albania</span>
              </li>
            </ul>
            <div className="footer-social">
              <a href="https://www.instagram.com/msc_certifications" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              ...
              <a href="https://www.linkedin.com/company/msc-certifications/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
