    ...
    <div className="about">
      ...
      <section className="about-hero">
        <div className="container">
          ...
          <div className="about-intro-small">
            ...
            <p>
              We provide a complete portfolio of services in ISO certification, CE marking, and technical evaluation,
      ...
      <section className="section section-white">
        <div className="container">
          ...
          <p className="about-text">
            Our mission is to help organizations meet global compliance requirements, improve operational efficiency,
            and strengthen their competitive position.
          </p>
          <p className="about-text">
            With a team of qualified auditors and technical experts, we combine international expertise with local
        ...
        <div className="container">
          ...
          <div className="mission-vision-grid">
            <div className="mission-card">
              ...
              <p>
                We are committed to providing objective, transparent, and technically competent assessments that
                strengthen client confidence, improve performance, and promote sustainable development.
              </p>
              <p className="highlight-text">
                We believe certification is more than a document. It's a tool for continuous improvement and
                global recognition.
              </p>
            </div>
            ...
            <div className="vision-card">
              ...
              <p>
                We aim to set the benchmark for integrity, expertise, and value-added certification, helping businesses
        ...
        <div className="container">
          ...
          <div className="quality-commitments">
            <div className="quality-item">
              ...
              <p>
                We listen, understand, and deliver certification services that meet client needs while maintaining
            ...
            <div className="quality-item">
              ...
              <p>
                Our auditors are carefully selected, trained, and continuously evaluated to ensure expertise in their
            ...
            <div className="quality-item">
              ...
              <p>
                All certification decisions are made free from commercial, financial, or other pressures that could
            ...
            <div className="quality-item">
              ...
              <p>
                We operate in full accordance with national and international regulations, accreditation requirements,
            ...
            <div className="quality-item">
              ...
              <h4>Continuous Improvement</h4>
              <p>
                We regularly review and improve our processes, respond to feedback, and adapt to changes in standards,
          ...
          <div className="policy-footer">
            <p>
              This commitment to quality ensures that every certificate we issue represents a credible, meaningful,
        ...
        <div className="container">
          ...
          <div className="ethics-grid">
            ...
            <div className="ethics-card">
              ...
              <p>
                We operate in accordance with national and international regulations, accreditation requirements,
                and data protection laws.
              </p>
            </div>
          </div>
      ...
      <section id="accreditation" className="section section-white">
        <div className="container">
          ...
          <div className="accreditation-intro">
            ...
            <p className="about-text centered">
              Accreditation confirms our technical competence, impartiality, and compliance with the requirements
              of <strong>ISO/IEC 17021</strong> (Management System Certification) and other relevant international
              standards. It is your assurance that our audits, assessments, and certifications are performed to
          ...
          <div className="accreditation-grid">
            <div className="accreditation-card">
              ...
              <p>
                Certificates issued under accredited status are accepted worldwide, ensuring international market
            ...
            <div className="accreditation-card">
              ...
              <p>
                Accreditation builds confidence among clients, authorities, and stakeholders in the credibility
            ...
            <div className="accreditation-card">
              ...
              <p>
                Independent surveillance by accreditation bodies guarantees our neutrality, fairness, and consistency
                in decision-making.
              </p>
            </div>
            ...
            <div className="accreditation-card">
              ...
              <h4>Continuous Improvement</h4>
              <p>
                Regular external assessments ensure that our systems remain effective, transparent, and aligned with
        ...
        <div className="container">
          ...
          <div className="partnerships-grid">
            <div className="partnership-card">
              ...
              <p>
                We cooperate with industry associations that promote best practices, technical innovation, and
          ...
          <div className="partnership-footer">
            <p>
              Every partnership is founded on mutual respect, professionalism, and ethical cooperation, ensuring
