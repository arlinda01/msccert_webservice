# 🚀 Deployment Guide - MSC Certifications Web Service
...
- ✅ GitHub account (to connect to Render and Netlify)
...
✅ **Yes, QR codes work when live!** Here's how:
...
**Solution:**
```bash
# In Render shell (via Dashboard → "Shell")
...
- Go to Dashboard → Your site → **"Functions"** → **"Logs"**
...
- ⚠️ Limited to 1GB on Render free tier
- ⚠️ Not suitable for high traffic or multiple dynos
...
**🎉 Congratulations! Your MSC Certifications app is now live!**
